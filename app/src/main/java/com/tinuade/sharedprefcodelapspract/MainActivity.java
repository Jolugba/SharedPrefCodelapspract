package com.tinuade.sharedprefcodelapspract;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = " com.tinuade.sharedprefcodelapspract.sharedprefs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowCountTextView=findViewById(R.id.counterScore);
